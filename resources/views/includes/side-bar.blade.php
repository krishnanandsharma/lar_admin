    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        <li class="nav-item nav-profile">
          <a href="{{url('my-profile')}}/{{ auth()->user()->id }}" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url('button')}}">Buttons</a></li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="general-pages">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url('blank-page')}}"> Blank Page </a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url('secure-login')}}"> Login </a></li>

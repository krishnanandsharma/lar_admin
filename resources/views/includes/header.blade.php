    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{url('home') }}"><img src="{{ URL::asset('images/logo.svg'); }}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="{{url('home') }}"><img src="{{ URL::asset('images/logo-mini.svg'); }}" alt="logo" /></a>
        </div>
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="javascript::void(0)" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  @if((auth()->user()->image) !=null)
                    <img src="{{ URL::asset('public/uploads/profile_image'); }}/{{auth()->user()->image}}" alt="image">
                  @else
